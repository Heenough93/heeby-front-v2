...
export function JournalDetail({ journalId }: JournalDetailProps) {
  ...
  const getReadableJournalById = useJournalStore(
    (state) => state.getReadableJournalById
  );
  ...
  const journal = useMemo(
    () => getReadableJournalById(journalId, accessMode),
    [accessMode, getReadableJournalById, journalId]
  );
